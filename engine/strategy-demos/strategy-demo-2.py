...
def handle_data(context, data):
    ...
    order(symbol('ABEV3'), 10)
    order(symbol('GGBR4'), 10)
    order(symbol('ITUB4'), 10)
    order(symbol('MGLU3'), 10)
    record(PETR4=data.current(symbol('PETR4'), 'price'),
            ABEV3=data.current(symbol('ABEV3'), 'price'),
            GGBR4=data.current(symbol('GGBR4'), 'price'),
            ITUB4=data.current(symbol('ITUB4'), 'price'),
            MGLU3=data.current(symbol('MGLU3'), 'price'))
